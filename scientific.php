    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="d-flex align-items-center mb-4">
                <div class="ms-4">
                    <p><i class="fa fa-check text-primary me-2"></i>Two parallel workshops(with course fee of Rs. 2000) on 12th October – one on LASERS IN DERMATOLOGY and second on TRICHOLOGY including HAIR TRANSPLANT and SCALP MICROPIGMENTATION</p>
