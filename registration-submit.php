                        ...
                        <form id="registation-form" method="post" action="payment.php">
                            <div class="form-group row">
                                <div class="col-sm-6"> <label class="small">IADVL Number (Eg. LM/K/99999)</label>
                                    <input type="text" readonly value="<?= (isset($data['membership_no'])) ? $data['membership_no'] : '' ?>" class="form-control member-no" name="membership_no" minlength="6" maxlength="20" placeholder="Enter IADVL Number">
                                </div>
                            ...
                            <div class="member-auto-fill">
                                <div class="form-group mt-3 row">
                                    <div class="col-sm-6"> <label>First Name</label>
                                        <input type="text" required="" value="<?= (isset($data['first_name'])) ? $data['first_name'] : '' ?>" class="form-control first_name" name="first_name" minlength="3" maxlength="100" placeholder="Enter first name">
                                    </div>
                                    <div class="col-sm-6 mt-3 mt-sm-0"> <label>Last Name</label>
                                        <input type="text" required="" value="<?= (isset($data['last_name'])) ? $data['last_name'] : '' ?>" class="form-control last_name" name="last_name" maxlength="100" placeholder="Enter last name">
                                    </div>
                                </div>
                                <div class="form-group mt-3 row">
                                    <div class="col-lg-6"> <label>Designation</label>
                                        <input type="text" value="<?= (isset($data['designation'])) ? $data['designation'] : '' ?>" class="form-control designation" name="designation" minlength="3" maxlength="100" placeholder="Enter designation">
                                    </div>
                                    ...
                                    <div class="col-6 col-lg-3 mt-3 mt-lg-0"> <label>Age</label>
                                        <input type="number" value="<?= (isset($data['age'])) ? $data['age'] : '' ?>" class="form-control age" name="age" minlength="2" maxlength="2" min="18" placeholder="Enter age">
                                    </div>
                                </div>
                                <div class="form-group mt-3 row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group mt-3 row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="email" required="" value="<?= (isset($data['email'])) ? $data['email'] : '' ?>" class="form-control email" name="email" placeholder="Enter email ID">
                                    </div>
                                    <div class="col-sm-6 mt-3 mt-sm-0"> <label>Mobile No</label>
                                        <input type="text" value="<?= (isset($data['mobile'])) ? $data['mobile'] : '' ?>" class="form-control mobile" name="mobile" minlength="10" maxlength="10" placeholder="Enter 10 digit mobile no.">
                                    </div>
                                </div>
                                <div class="form-group mt-3"> <label>Address line 1</label>
                                    <input type="text" value="<?= (isset($data['address_line1'])) ? $data['address_line1'] : '' ?>" class="form-control address_line1" name="address_line1" minlength="3" maxlength="250" placeholder="Enter address line 1">
                                </div>
                                ...
                                <div class="form-group mt-3 row">
                                    <div class="col-sm-6 col-lg-2"> <label>Pincode</label>
                                        <input type="text" class="form-control pincode" value="<?= (isset($data['pincode'])) ? $data['pincode'] : '' ?>" name="pincode" minlength="6" maxlength="6" placeholder="Enter pincode">
                                    </div>
                                    <div class="col-sm-6 col-lg-5 mt-3 mt-sm-0"> <label>City</label>
                                        <input type="text" class="form-control city" value="<?= (isset($data['city'])) ? $data['city'] : '' ?>" name="city" minlength="3" maxlength="100" placeholder="Enter city">
                                    </div>
                                    <div class="col-sm-6 col-lg-5 mt-3 mt-lg-0"> <label>State</label>
                                        <input type="text" class="form-control state" value="<?= (isset($data['state'])) ? $data['state'] : '' ?>" name="state" minlength="3" maxlength="50" placeholder="Enter state">
                                    </div>
                                </div>
                                <div class="form-group mt-3"> <label>Institution</label>
                                    <input type="text" value="<?= (isset($data['institution'])) ? $data['institution'] : '' ?>" class="form-control" name="institution" minlength="3" maxlength="255" placeholder="Enter institution">
                                </div>
                                <div class="form-group mt-3 row">
                                    <div class="col-sm-6"> <label>No. of co-delegates</label>
                                        <select class="form-control" name="co_delegates" required="">
                                ...
                                <div class="form-group mt-3 row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            <input required="" <?= (isset($data['workshop']) && $data['workshop'] == 'None') ? 'checked' : '' ?> name="workshop" type="radio" value="None" id="None" checked> None
                                            <input required="" <?= (isset($data['workshop']) && $data['workshop'] == 'Lasers') ? 'checked' : '' ?> name="workshop" type="radio" value="Lasers" id="Lasers"> Lasers
                                            <input required="" <?= (isset($data['workshop']) && $data['workshop'] == 'Trichology') ? 'checked' : '' ?> name="workshop" type="radio" value="Trichology" id="Trichology"> Trichology
                                        </div>
                                    </div>
                                </div>
